...
<html lang="en">
  <head>
    ...
    <meta name="description" content="<%= contents.getTitle() %>">
    ...
    <link rel="stylesheet" href="<%= request.getContextPath() %>/assets/css/select2.css">
    <link rel="stylesheet" href="<%= request.getContextPath() %>/assets/css/dropzone.css">
    <link rel="stylesheet" href="<%= request.getContextPath() %>/assets/css/uppy.min.css">
    <link rel="stylesheet" href="<%= request.getContextPath() %>/assets/css/jquery.steps.css">
    <link rel="stylesheet" href="<%= request.getContextPath() %>/assets/css/jquery.timepicker.css">
    <link rel="stylesheet" href="<%= request.getContextPath() %>/assets/css/quill.snow.css">
  ...
  <body class="vertical  light  ">
    <div class="wrapper">
        <nav class="topnav navbar navbar-light">
            <button type="button" class="navbar-toggler text-muted mt-2 p-0 mr-3 collapseSidebar" title="Voir">
          ...
          <div class="row justify-content-center">
            <div class="col-12">
              <div class="row align-items-center mb-2">
                <div class="col">
                  <h1 class="h1 page-title"><%= contents.getTitle() %></h1>
                </div>
              </div>
                  ...
                  <div class="card-body">
                    <div class="row mt-1 align-items-center">
                      <div class="col-12 text-left pl-4">
                        <%= contents.getContent() %>
                        <p class="text-right pr-5"><%= contents.getAdmin().getMail() %></p>
                        <p class="text-right pr-5">le <fmt:formatDate type = "both" value = "<%= contents.getDateHour() %>" /></p>
                      </div>
                    </div>
                  </div> <!-- .card-body -->
                </div> <!-- .card -->
    ...
    </div> <!-- .wrapper --><script src="<%= request.getContextPath() %>/assets/js/jquery.min.js"></script>
    ...
    <script src='<%= request.getContextPath() %>/assets/js/jquery.timepicker.js'></script>
